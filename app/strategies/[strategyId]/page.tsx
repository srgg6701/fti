            ...
            <article className="rounded-2xl border border-white/10 bg-white/[0.02] p-4">
              <header className="mb-3 flex items-center gap-3">
                <img
                  ...
                  src="/images-temp/Strategies/image2381.png"
                />
                <div className="flex flex-col">
                  <span className="text-sm font-medium">username</span>
                  <span className="text-xs text-white/60">TimeFrame: 6 Months</span>
                </div>
              </header>
              ...
              <div className="mb-4">
                ...
                <div className="mt-3 h-24 w-full overflow-hidden rounded-md border border-white/10 bg-white/[0.03]">
                  <img
                    alt="Vector2381"
              ...
              <footer className="flex items-center justify-between text-xs">
                <span className="text-emerald-400">ROI: 51.25%</span>
                <span className="text-white/70">RISK: 5</span>
              </footer>
            </article>
            ...
            <article className="rounded-2xl border border-white/10 bg-white/[0.02] p-4">
              <header className="mb-3 flex items-center gap-3">
                <img
                  alt="avatar"
                  className="h-7 w-7 rounded-full border border-white/10 object-cover"
                  src="/images-temp/4e1d7a54ded1.png"
                />
                <div className="flex flex-col">
                  <span className="text-sm font-medium">username</span>
                  <span className="text-xs text-white/60">TimeFrame: 6 Months</span>
              ...
              <div className="mb-4">
                ...
                <div className="mt-3 h-24 w-full overflow-hidden rounded-md border border-white/10 bg-white/[0.03]">
                  <img
                    ...
                    src="/images-temp/Strategies/vector2382.svg"
                  />
                  <img
                    alt="Vector22382"
                    src="data:image/svg+xml;base64,"
            ...
            <article className="rounded-2xl border border-white/10 bg-white/[0.02] p-4">
              <header className="mb-3 flex items-center gap-3">
                <img
                  alt="avatar"
                  className="h-7 w-7 rounded-full border border-white/10 object-cover"
                  src="/images-temp/Strategies/image2382.png"
                />
                <div className="flex flex-col">
                  <span className="text-sm font-medium">username</span>
                  <span className="text-xs text-white/60">TimeFrame: 6 Months</span>
            ...
            <article className="rounded-2xl border border-white/10 bg-white/[0.02] p-4">
              <header className="mb-3 flex items-center gap-3">
                <img
                  alt="avatar"
                  className="h-7 w-7 rounded-full border border-white/10 object-cover"
                  src="/images-temp/3e4e26874506.png"
                />
                <div className="flex flex-col">
                  <span className="text-sm font-medium">username</span>
                  <span className="text-xs text-white/60">TimeFrame: 6 Months</span>
            ...
            <article className="rounded-2xl border border-white/10 bg-white/[0.02] p-4">
              <header className="mb-3 flex items-center gap-3">
                <img
                  alt="avatar"
                  className="h-7 w-7 rounded-full border border-white/10 object-cover"
                  src="/images-temp/8197e38a37b8.png"
                />
                <div className="flex flex-col">
                  <span className="text-sm font-medium">username</span>
                  <span className="text-xs text-white/60">TimeFrame: 6 Months</span>
              ...
              <div className="mb-4">
                ...
                <div className="mt-3 h-24 w-full overflow-hidden rounded-md border border-white/10 bg-white/[0.03]">
                  <img
                    alt="Performance"
                    className="h-full w-full object-cover"
                    src="/images-temp/Strategies/vector2383.svg"
                  />
                  <img
                    alt="Vector22383"
                    src="data:image/svg+xml;base64,"
              ...
              <div className="mb-4">
                ...
                <div className="mt-3 h-24 w-full overflow-hidden rounded-md border border-white/10 bg-white/[0.03]">
                  <img
                    alt="Performance"
                    className="h-full w-full object-cover"
                    src="/images-temp/Strategies/vector2384.svg"
                  />
                  <img
                    alt="Vector22384"
                    src="data:image/svg+xml;base64,"
              ...
              <div className="mb-4">
                ...
                <div className="mt-3 h-24 w-full overflow-hidden rounded-md border border-white/10 bg-white/[0.03]">
                  <img
                    alt="Performance"
                    className="h-full w-full object-cover"
                    src="/images-temp/Strategies/vector2385.svg"
                  />
                  <img
                    alt="Vector22385"
              ...
              <div className="mb-4">
                ...
                <div className="mt-3 h-24 w-full overflow-hidden rounded-md border border-white/10 bg-white/[0.03]">
                  <img
                    alt="Performance"
                    className="h-full w-full object-cover"
                    src="/images-temp/Strategies/vector2386.svg"
                  />
                  <img
                    alt="Vector22386"
                    src="data:image/svg+xml;base64,"
