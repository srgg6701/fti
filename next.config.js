  ...
  async rewrites() {
    return [
      ...
      // allow signin with provider segment (e.g. /api/auth/signin/google)
      {
        ...
        destination: "/api/auth/signin/:provider*",
      },
      { source: "/api/auth/signout", destination: "/api/auth/signout" },
      // optionally allow signout with provider segment
      {
        source: "/api/auth/signout/:provider*",
        destination: "/api/auth/signout/:provider*",
      },
      ...
      {
        source: "/api/:path*",
        destination: "https://api.fti-trade.com/:path*",
      },
    ];
  },
  images: {
